...
export function Footer() {
  return (
    <div className="group">
      <footer className="bg-secondary/50 dark:bg-card py-6 border-t border-transparent group-hover:border-black dark:group-hover:border-white transition-colors duration-300">
